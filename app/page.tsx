...
function CatCompanion({
  ...
  return (
    <aside className={`cat-companion cat-${variant}`} aria-live="polite" aria-label="伍六七城市生活向导">
      <div className="cat-portrait"><img src="/cat-guide-potential.png" alt="举起前爪、好奇地陪用户探索武汉生活圈的黑白德文卷毛猫伍六七" /></div>
      <div className="cat-bubble"><small>城市侦探 · 伍六七</small><p>{line}</p></div>
    </aside>
  );
}
